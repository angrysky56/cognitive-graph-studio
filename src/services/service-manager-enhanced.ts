...
class ServiceManager {
  ...
  private async initializeVectorService(): Promise<void> {
    try {
      // Initialize vector service with proper configuration structure
      ...
      const persistencePath = import.meta.env.VITE_VECTOR_PERSISTENCE_PATH || './data/vectors'
      const persistenceEnabled = import.meta.env.VITE_VECTOR_PERSISTENCE_ENABLED === 'true'
